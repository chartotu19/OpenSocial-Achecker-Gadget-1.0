...
function twitter(){
window.open ("http://energisenow.elementfx.com/test/twitter/twitter_login.php","Twitter","menubar=1,resizable=1,width=800,height=500");
...
function test(){
pdf= pdf.replace(/^\s*|\s*$/g,'');
window.open("http:/www.energisenow.elementfx.com/test/pdfcreate.php?data="+pdf);
}
